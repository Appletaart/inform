...
export default class BesturenController extends Controller {
  ...
  @tracked gemeente;
  @tracked population;
  @tracked een_bestuurseenheid;
  @tracked een_burgemeester;
  @tracked een_schepenen;
  @tracked een_tschepenen;
  @tracked een_voorZgr;
  @tracked een_gr;
  ...
  */
  ...
  get getBestuur() {
    let bestuurseenheids = d3.group(this.model, d => d.bestuurseenheidLabel);
